 ...
 */
public class MergeSort implements AlgorithmSort {
     ...
     */
    private void merge(int[] a, final int left, final int mid, final int right) {
     ...
     */
    private void mergeSort(int[] a, final int left, final int right) {
        if (left < right) {
            int q = (left + right) >> 1;
            mergeSort(a, left, q);
