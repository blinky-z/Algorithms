...
- Если нужна LIFO или FIFO коллекция
...
[[Interface] Map](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Map.html) - это интерфейс, представляющий собой АТД «Ассоциативный массив (Словарь, Map)».

Мапа позволяет хранить пары типа <ключ, значение>.
...
согласно некоторому компаратору, но не самый первый пришедший элемент.
